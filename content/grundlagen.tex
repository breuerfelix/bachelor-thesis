...
Welcher Algorightmus eignesetzt wird hängt stark von der Situation ab, in der der \ac{lb} verwendet wird.
...
Alle Server werden in eine Liste eigetragen. Der Round robin Algorightmus leitet Traffic immer an den ersten Server in der Liste und verschiebt diesen Server danach an das Ende der Liste.
Dieser Algorightmus teilt alle Anfragen gleichmäßig auf die Server auf und findet oft Anwendung wenn alle Server die gleichen Ressourcen zur verfügung haben.
\cite{WhatLoadBalancer}
