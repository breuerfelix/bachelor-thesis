...
\begin{itemize}
    \item Multi-level '\verb|#|': Schlie{\ss}t das Vorgänger- und alle nachfolgenden Topic levels mit ein.
    \item Single-level '\verb|+|': Schlie{\ss}t alle Topic levels auf einer einzigen Ebene mit ein.
\end{itemize}
