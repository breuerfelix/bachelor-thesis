...
In Kapitel \ref{ss:circuit-breaking} wurde beschrieben, dass man über die Control Plane den Health Status der Nodes eines Clusters angeben kann. Der Health Status gibt an, ob ein Node neue Client Verbindungen erhalten kann.
...
% TODO kapitel vielleicht löschen
