...
% TODO diagram wo der LB ein teil ist und man alle komponenten sieht
...
Abbildung \ref{fig:s1-rr} und \ref{fig:s1-lc} zeigen den zeitlichen Verlauf von Testszenario 1 für einen Round Robing und Least Connection Load Balancer.
...
\subsubsection{Health Check} \ref{ss:health-check}
