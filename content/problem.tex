...
Bei einem Round-Robin Load Balancer führt dieses Verhalten zu einer ungleichen Lastverteilung im Cluster. Ein \ac{lb} muss in der Lage sein, die eingehenden Verbindungen auf die Nodes eines HiveMQ Clusters basierend ihrere derzeitigen Arbeitslast zu gewichten.
