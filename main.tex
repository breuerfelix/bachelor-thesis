...
\usepackage{graphicx}
\usepackage{ragged2e}
\usepackage{amsmath} % used for formulas
...
- welche metriken hab ich mir angeschaut ?
...
future work:
- nur die cpu abfragen und nicht alle hivemq metriken
- roaming clients
\end{comment}
...
\section{Technische Grundlangen}
\subsection{MQTT}
...
\subsubsubsection{Maglev}
\subsubsubsection{Ring Hash}
\subsubsubsection{Random}
\subsubsection{Envoy}
